...
const buttonVariants = cva(
  "inline-flex h-11 items-center justify-center gap-2 rounded-md px-5 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gold text-white hover:bg-[#9f751b] focus-visible:outline-gold",
        outline: "border border-gold/40 bg-white/70 text-foreground hover:bg-gold/10",
        ghost: "text-foreground hover:bg-gold/10",
        dark: "bg-foreground text-white hover:bg-[#3b332d]"
      },
      size: {
        default: "h-11 px-5",
        sm: "h-9 px-3",
